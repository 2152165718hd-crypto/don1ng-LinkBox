...
don1ng LinkBox 是一个 Flutter Android 应用，用于把 OneNET Studio 物模型设备快速接入手机端监控和控制面板。当前版本默认使用设备 Token 快速接入，可导入 `Token.log` 或手动填写设备连接信息后通过 MQTT 连接和控制；物模型 JSON 在物模型页单独导入，需要云端历史查询时仍可启用高级应用接入。
...
- 最新版本：`v0.6.0`
- 应用版本：`0.6.0+7`
- Release 页面：[don1ng LinkBox v0.6.0](https://github.com/2152165718hd-crypto/don1ng-LinkBox/releases/tag/v0.6.0)
